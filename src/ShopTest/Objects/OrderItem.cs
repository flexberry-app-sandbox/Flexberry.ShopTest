...
namespace IIS.ShopTest
{
    ...
    public class OrderItem : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.ShopTest.Order.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View OrderItemE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("OrderItemE", typeof(IIS.ShopTest.OrderItem));
                }
            }
            ...
            public static ICSSoft.STORMNET.View OrderItemInOrderL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("OrderItemInOrderL", typeof(IIS.ShopTest.OrderItem));
                }
            }
        }
    }
    ...
    public class DetailArrayOfOrderItem : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ShopTest.DetailArrayOfOrderItem members)

        // *** End programmer edit section *** (IIS.ShopTest.DetailArrayOfOrderItem members)
        ...
        /// </summary>
        public DetailArrayOfOrderItem(IIS.ShopTest.Order fOrder) : 
                base(typeof(OrderItem), ((ICSSoft.STORMNET.DataObject)(fOrder)))
        {
        }
        
        public IIS.ShopTest.OrderItem this[int index]
        {
            get
            {
                return ((IIS.ShopTest.OrderItem)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ShopTest.OrderItem dataobject)
        {
