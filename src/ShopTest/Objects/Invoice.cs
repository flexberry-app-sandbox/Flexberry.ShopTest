...
namespace IIS.ShopTest
{
    ...
    public class Invoice : IIS.ShopTest.Document
    {
        
        private IIS.ShopTest.InvoiceStatus fStatus = IIS.ShopTest.InvoiceStatus.New;
        ...
        private IIS.ShopTest.Order fOrder;
        
        private IIS.ShopTest.Employee fResponsiblePerson;
        
        private IIS.ShopTest.DetailArrayOfInvoiceItem fInvoiceItem;
        ...
        public virtual IIS.ShopTest.InvoiceStatus Status
        {
            get
            {
                ...
                IIS.ShopTest.InvoiceStatus result = this.fStatus;
        ...
        [PropertyStorage(new string[] {
                "Order"})]
        public virtual IIS.ShopTest.Order Order
        {
            get
            {
                ...
                IIS.ShopTest.Order result = this.fOrder;
        ...
        [PropertyStorage(new string[] {
                "ResponsiblePerson"})]
        public virtual IIS.ShopTest.Employee ResponsiblePerson
        {
            get
            {
                ...
                IIS.ShopTest.Employee result = this.fResponsiblePerson;
        ...
        public virtual IIS.ShopTest.DetailArrayOfInvoiceItem InvoiceItem
        {
            get
            {
                ...
                {
                    this.fInvoiceItem = new IIS.ShopTest.DetailArrayOfInvoiceItem(this);
                }
                IIS.ShopTest.DetailArrayOfInvoiceItem result = this.fInvoiceItem;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View InvoiceE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("InvoiceE", typeof(IIS.ShopTest.Invoice));
                }
            }
            ...
            public static ICSSoft.STORMNET.View InvoiceL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("InvoiceL", typeof(IIS.ShopTest.Invoice));
                }
            }
        }
    }
