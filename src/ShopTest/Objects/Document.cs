    ...
    public class Document : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View DocumentE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("DocumentE", typeof(IIS.ShopTest.Document));
                }
            }
            ...
            public static ICSSoft.STORMNET.View DocumentL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("DocumentL", typeof(IIS.ShopTest.Document));
                }
            }
        }
    }
