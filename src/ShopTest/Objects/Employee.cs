...
namespace IIS.ShopTest
{
    ...
    public class Employee : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ShopTest.PositionList fPosition;
        ...
        public virtual IIS.ShopTest.PositionList Position
        {
            get
            {
                ...
                IIS.ShopTest.PositionList result = this.fPosition;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View EmployeeE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("EmployeeE", typeof(IIS.ShopTest.Employee));
                }
            }
            ...
            public static ICSSoft.STORMNET.View EmployeeL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("EmployeeL", typeof(IIS.ShopTest.Employee));
                }
            }
        }
    }
