...
namespace IIS.ShopTest
{
    ...
    public class InvoiceItem : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ShopTest.Invoice fInvoice;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.ShopTest.Invoice.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Invoice"})]
        public virtual IIS.ShopTest.Invoice Invoice
        {
            get
            {
                ...
                IIS.ShopTest.Invoice result = this.fInvoice;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View InvoiceItemE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("InvoiceItemE", typeof(IIS.ShopTest.InvoiceItem));
                }
            }
        }
    }
    ...
    public class DetailArrayOfInvoiceItem : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ShopTest.DetailArrayOfInvoiceItem members)

        // *** End programmer edit section *** (IIS.ShopTest.DetailArrayOfInvoiceItem members)
        ...
        /// </summary>
        public DetailArrayOfInvoiceItem(IIS.ShopTest.Invoice fInvoice) : 
                base(typeof(InvoiceItem), ((ICSSoft.STORMNET.DataObject)(fInvoice)))
        {
        }
        
        public IIS.ShopTest.InvoiceItem this[int index]
        {
            get
            {
                return ((IIS.ShopTest.InvoiceItem)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ShopTest.InvoiceItem dataobject)
        {
